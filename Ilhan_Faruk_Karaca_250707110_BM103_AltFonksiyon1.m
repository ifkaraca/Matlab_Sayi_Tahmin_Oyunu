...
function sayi=Ilhan_Faruk_Karaca_250707110_BM103_AltFonksiyon1 %imza

while true %istenilen şartlar oluşana kadar döngüde kalması sağlanır
    ...
    if (d1 ~= d2) && (d1 ~= d3) && (d1 ~= d4) && (d2 ~= d3) && (d2 ~= d4) && (d3 ~= d4) % sayıların benzersizliği sorgulanır
